...
* TODO Joy of FUN(ctional) LANGUAGES (re-search-forward "\"orgtrello-id\"")
:PROPERTIES:
:orgtrello-id: 52b569ea0edf7e64300053da
:END:
  - [X] Emacs-Lisp :PROPERTIES: {"orgtrello-id": "52b569ea0edf7e64300053da"}
  - [X] Common-Lisp
  - [ ] Scheme
  - [X] Clojure
- [X] ML family
